...
<nav class="navbar navbar-default navbar-fixed-top"><!--applies BS nav bar styles and effects-->
	...
	<div class="row blacktop">
		...
		<div class="hidden-xs col-sm-6 phone">
			<p>$CAD <a href="http://www.thecupstore.ca"><span class="flag-icon flag-icon-ca"></span></a> <a href="http://www.thecupstore.com"><span class="flag-icon flag-icon-us-tsp"></span></a> <a href="tel:+18666415900">Toll-Free: 1-866-641-5900</a></p>
		</div>

		<div class="visible-xs col-xs-12 phone">
			<p>$CAD <a href="http://www.thecupstore.ca"><span class="flag-icon flag-icon-ca"></span></a> <a href="http://www.thecupstore.com"><span class="flag-icon flag-icon-us-tsp"></span></a> </p>
		</div>
...
<!--2nd ROW-->
	...
	<div class="QR-bar visible-xs-block"><a href="form/quote-request.php">Request a Quote</a></div><!--Quote Request bar appears on mobile only-->
